...
`../api/openai-api-reference.md:51-74` (the request-body schema this repo
...
`../api/openai*` file lists it as valid.
...
Completions schema documented in `../api/openai-api-reference.md`. It does not
